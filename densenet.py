...
image_size = 224
model_name = "all_freezed_densenet201_smalltest_softmax.h5"
#Load the VGG model
#SET weights
dense_conv = DenseNet201(weights='imagenet', include_top=False, input_shape=(image_size, image_size, 3))

# Freeze all the layers
# :-n, n = # of open layers
for layer in dense_conv.layers[:]:
    #SET trainable
