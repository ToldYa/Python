"""
TEST mobilenetmodell testkörd för både random och imagenetvärden
Skapa testgenerator
...
image_size = 224
model_name = "mobilenetv1_test.h5"
#Load the VGG model
#SET weights
vgg_conv = MobileNet(weights=None, include_top=False, input_shape=(image_size, image_size, 3))
