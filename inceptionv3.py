"""
inceptionv3-modell testkörd för både random och imagenetvärden
Skapa testgenerator
...
image_size = 224
model_name = "all_freezed_inceptionv3_softmax.h5"
#Load the VGG model
#SET weights
inv3_conv = InceptionV3(weights='imagenet', include_top=False, input_shape=(image_size, image_size, 3))

# Freeze all the layers
# :-n, n = # of open layers
for layer in inv3_conv.layers[:]:
    #SET trainable
