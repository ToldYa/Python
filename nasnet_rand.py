...
"""
#####SESSION VARIABLES!!!#####
f = open("trainmetrics_nasnet_randTEST.txt", "w+")
all_batch_size = 20
num_of_epochs = 10
...
image_size = 224
model_name = "nasnet_randTEST.h5"
test_file_stats = "testmetrics_nasnet_randTEST.txt"
##############################
...
base_model=NASNetMobile(weights=None, include_top=False, input_shape=(image_size, image_size, 3)) #imports the resnet model and discards the last 1000 neuron layer.
...
for i,layer in enumerate(model.layers):
    print("layer nr:",x,i,layer.name,layer.trainable)
